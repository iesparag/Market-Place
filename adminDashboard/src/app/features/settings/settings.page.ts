...
interface Settings { commissionPercent: number; taxPercent: number; deliveryFee: number; freeDeliveryAbove: number; payoutHoldDays: number; currency: string; }
...
@Component({
  ...
  `,
  styles: [`.head { margin-bottom: 20px; } .label { margin-top: 10px; } .btn-primary { margin-top: 16px; }`],
})
