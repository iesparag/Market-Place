...
import { CatalogService, type CatNode } from '../core/services/catalog.service';
    ...
    <header>
      <div class="topbar">
        <div class="hbar">
          ...
          <form class="search" (submit)="doSearch($event)">
            <input #q placeholder="Search for products, brands and vendors" />
...
export class HeaderComponent implements OnInit {
  ...
  @HostListener('document:click') onDocClick(): void { this.open.set(null); }
